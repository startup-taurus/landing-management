...
//
// LIMITACIÓN: el estado vive en el proceso. Funciona en un VPS único, pero se
// reinicia/duplica en despliegues multi-instancia o serverless. Para escalar,
// migrar a un store compartido (Redis / Upstash).
...
/**
 * Extrae la IP del cliente. Tras un proxy inverso (nginx) se usa x-forwarded-for.
 * NOTA: x-forwarded-for es falsificable salvo que el proxy lo fije de forma confiable.
 */
